"""
FastAPI routes for simplified agent capabilities.
"""
...
# Create router
router = APIRouter(prefix="/simple-agent", tags=["SimpleAgent"])


@router.post("/process", response_model=Dict[str, Any])
async def process_simple_agent_request(
    query_request: ChatMessageRequest,
    user_id: str = Form(...)
):
    """
    Process a request using the simplified agent.
