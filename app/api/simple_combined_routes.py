"""
FastAPI routes for simple combined agent capabilities.
"""
...
# Create router
router = APIRouter(prefix="/simple-combined", tags=["SimpleCombined"])


@router.post("/process", response_model=Dict[str, Any])
async def process_simple_combined_request(
